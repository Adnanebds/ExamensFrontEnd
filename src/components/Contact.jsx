...
<div class="flex justify-center items-center w-screen h-screen bg-white dark:bg-gray-900">
	...
	<div class="container mx-auto my-4 px-4 lg:px-20">
		...
		<div class="w-full p-8 my-4 md:px-12 lg:w-9/12 lg:pl-20 lg:pr-40 mr-auto rounded-2xl shadow-2xl">
			<div class="flex">
				<h1 class="font-bold uppercase text-5xl">Stuur ons <br /> een bericht!</h1>
			</div>
            ...
            type="email" placeholder="E-mail*" />
				<input class="w-full bg-gray-100 text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline"
            type="number" placeholder="Telefoonnummer*" />
        </div>
				<div class="my-4">
					<textarea placeholder="Uw Bericht*" class="w-full h-32 bg-gray-100 text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline"></textarea>
				</div>
			...
			<div
				...
				<div class="flex flex-col text-white">
					<h1 class="font-bold uppercase text-4xl my-4">U Kunt ons vinden in</h1>
            ...
            <div class="flex flex-col">
              <h2 class="text-2xl">Ons Kantoor</h2>
